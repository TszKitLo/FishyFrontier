...
// may use useParam for API call
  ...
  const [product, setProduct] = useState(
    { name: "Product A", description: "Product A 100g", stock: 10, cost: 20, sales_price: 5, item_number: "ABC123", expiryDate: "2022-10-28", location: "Shelf A22" },
  );
                ...
                <form>
                  ...
                  <div className="row mb-3">
                    ...
                    <label htmlFor="sales_price">Sales Price </label>
                      <input type="number" className="form-control" id="sales_price" name="sales_price" value={product.sales_price} onChange={handleChange}/>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    <div className="col">
                      ...
                      <input type="text" className="form-control" id="item_number" name="item_number" value={product.item_number} onChange={handleChange}/>
                    </div>
                  </div>
                  ...
                  <div className="row mb-3">
                    ...
                    <label htmlFor="sales_price">Location </label>
                      <input type="text" className="form-control" id="location" name="location" value={product.location} onChange={handleChange}/>
                    </div>
                  </div>
                  ...
                  <div className="row g-3 mt-4 mb-4">
                    ...
                    <div className="col">
                      <button className="btn btn-dark py-2 w-100">Save Change</button>
                    </div>
                  </div>
                </form>
              </div>
